...
def test_kb_flow():
    ...
    # 1. Simuler une injection de "Savoir" (Knowledge Ingestion)
    knowledge_id = str(uuid.uuid4())
    knowledge_vector = np.random.randn(768).tolist() # Simule un problème de rail
    knowledge_payload = {
        "id": knowledge_id,
    ...
    # 2. Simuler une requête utilisateur avec une image similaire
    # On ajoute un peu de bruit au vecteur pour simuler une image proche mais pas identique
    ...
    if ref_case:
        ...
        print(f"🛠️ Solution: {ref_case['solution']}")
